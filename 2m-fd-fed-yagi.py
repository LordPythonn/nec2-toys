...
# DE
a1 = Point(A/2.0, Y0-radiusB, Z0)
a2 = Point(-a1.x, Y0-radiusB, Z0)
b  = Point( a2.x, Y0,         Z0)
c1 = Point( a2.x, Y0+radiusB, Z0)
c2 = Point( a1.x, Y0+radiusB, Z0)
d  = Point( a1.x, Y0,         Z0)
# Ref
...
m.addArc(arcSegs, radiusB, start=deg(90), end=deg(270), rotate=Rotation(deg(90),deg(0),deg(0)), translate=b)
m.addWire(segs, c1, c2).feedAtMiddle()
m.addArc(arcSegs, radiusD, arcStart, arcEnd, rotate=Rotation(deg(90),deg(0),deg(180)), translate=d)
# Reflector
